...
var AddproductComponent = /** @class */ (function () {
    ...
    AddproductComponent.prototype.addproduct = function () {
        ...
        this.http.post(apurl, dataobj).subscribe(function (response) {
            console.log("response from addproduct api:", response);
            _this.toastr.success("product added");
        }, function (error) {
...
var AppComponent = /** @class */ (function () {
    ...
    // }]
    function AppComponent(http, commonservice) {
        var _this = this;
        this.http = http;
        ...
        if (localStorage.email) {
            ...
            this.http.post(cartapi, requestobj).subscribe(function (response) {
                console.log("response from cart api", response);
                _this.commonservice.cartitems = response["data"];
            }, function (error) {
...
var CartComponent = /** @class */ (function () {
    function CartComponent(http, toastr, router, commonservice) {
        ...
        if (!localStorage.email) {
            ...
            if (this.commonservice.cartitems.length > 0) {
                ...
                this.cartitems.forEach(function (each) {
                    _this.totalPrice = _this.totalPrice + each.productprice;
                });
            }
            else {
    ...
    CartComponent.prototype.remove = function (productid, item) {
        var _this = this;
        var obj = {
            email: localStorage.email,
            productid: productid
        ...
        this.http.post(removeapi, obj).subscribe(function (response) {
            console.log("============", _this.commonservice);
            if (response["code"] == 200) {
                console.log("item deleted");
                _this.toastr.success("item deleted");
            }
            else {
                console.log("Not removed properly");
                _this.toastr.success("item removed");
            }
        }, function (error) {
            _this.toastr.error("error from removeitemapi");
        });
    };
...
var CheckoutComponent = /** @class */ (function () {
    function CheckoutComponent(http, commonservice, toastr) {
        var _this = this;
        this.http = http;
        this.commonservice = commonservice;
        this.toastr = toastr;
        ...
        if (this.commonservice.cartitems.length > 0) {
            ...
            this.http.post(cartapi, { email: localStorage.email })
                ...
                console.log("response from cart api", response);
                _this.cartitems = response["data"];
                _this.cartitems.forEach(function (each) {
                    _this.totalPrice = _this.totalPrice + each.productprice;
                });
            }, function (error) {
    ...
    CheckoutComponent.prototype.placeOrder = function () {
        ...
        this.http.post(createorderapi, requestObj)
            .subscribe(function (response) {
            console.log("AGYE PLACEORDER  M", _this.commonservice);
            console.log("response from create order api", response);
            if (response["code"] == 200) {
                console.log("ordr placed");
                _this.toastr.success("Order Placed");
            }
            else {
                console.log("ordr not placed");
                _this.toastr.error("Order Not Placed");
            }
        }, function (error) {
            console.log("error from create order api", error);
            _this.toastr.warning("Order not placed properly");
        });
    };
...
var DeleteaccountComponent = /** @class */ (function () {
    function DeleteaccountComponent(http, toastr, router) {
        this.http = http;
        this.toastr = toastr;
        this.router = router;
    }
    ...
    DeleteaccountComponent.prototype.deleteaccount = function () {
        ...
        this.http.post(apurl, dataobj).subscribe(function (response) {
            ...
            if (response["code"] == 1100) {
                ...
                _this.toastr.success("Account deleted");
                localStorage.clear();
                _this.router.navigate(['/']);
            }
            else {
                _this.toastr.success("send mail");
            }
        }, function (error) {
            console.log("error from deleteaccount api", error);
            _this.toastr.error("Invalid account cant be deleetd");
        });
...
var GetproductComponent = /** @class */ (function () {
    function GetproductComponent() {
    }
    GetproductComponent.prototype.ngOnInit = function () {
    };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(http, commonservice) {
        var _this = this;
        this.http = http;
        this.commonservice = commonservice;
        this.products = [];
        if (commonservice.products.length > 0) {
            ...
            this.http.get(apiurl).subscribe(function (response) {
                ...
                _this.commonservice.products = response["data"];
            }, function (error) {
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        console.log("Data object ready", dataobj);
        this.http.post(apiurl, dataobj).subscribe(function (response) {
            console.log("response from login api:", response);
            if (response["code"] == 100) {
                localStorage.email = response["data"]["email"];
                _this.toastr.success("Login Done");
                _this.router.navigate(['/']);
            }
            else {
...
var NavbarComponent = /** @class */ (function () {
    ...
    NavbarComponent.prototype.deleteaccount = function () {
        this.isuserloggedin = false;
        localStorage.clear();
    };
...
var ProductdetailComponent = /** @class */ (function () {
    function ProductdetailComponent(http, activatedroute, toastr, router, commonservice) {
        var _this = this;
        this.http = http;
        ...
        this.http.get(apiurl).subscribe(function (response) {
            ...
            console.log(">>>>>>>>>>>>>>>>", _this.commonservice);
            if (_this.commonservice.cartitems.length <= 0) {
                _this.http.post(getcartapi, { email: localStorage.email })
                    .subscribe(function (response) {
                });
            }
            _this.commonservice.cartitems.forEach(function (each) {
                if (each.productid == _this.product["id"]) {
                    _this.productalreadyincart = true;
                }
            });
        }, function (error) {
    ...
    ProductdetailComponent.prototype.addToCart = function () {
        ...
        if (localStorage.email) {
            ...
            this.http.post(addtocartapi, requestobj)
                .subscribe(function (response) {
                if (response["code"] == 100) {
                    _this.toastr.success("Added To Cart");
                    //commonservice
                    _this.commonservice.cartitems = _this.commonservice.cartitems || [];
                    _this.commonservice.cartitems.push(response["data"]);
                    console.log("common service after", _this.commonservice);
                    _this.productalreadyincart = true;
                }
            }, function (error) {
                _this.toastr.error("Error in adding to cart");
            });
        }
        else {
...
var SignupComponent = /** @class */ (function () {
    ...
    SignupComponent.prototype.signup = function () {
        ...
        this.http.post(apiurl, requestobj).subscribe(function (response) {
            ...
            if (response["code"] == 200) {
                _this.toastr.warning("User already exists");
            }
            else {
                if (response["code"] == 100)
